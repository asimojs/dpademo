...
const GithubLogo = component("GithubLogo", () => {
    return <a href="https://github.com/asimojs/dpademo" target="_blank" aria-valuetext="Link to project's Github page">
        <svg width="28" height="28" viewBox="0 0 96 98" xmlns="http://www.w3.org/2000/svg">
